 ...
 * @param {org.accordproject.isda.irs.RateObservation} context.request - the incoming request
 * @param {org.accordproject.isda.irs.Result} context.response - the response
 * @param {concerto.Event} context.emit - the emitted events
 * @param {org.accordproject.runtime.State} context.state - the state
 */

function orgXaccordprojectXisdaXirsXSimpleInterestRateSwap_check(context) {
  let pcontext = Object.assign(context, { 'request' : context.request });
  return orgXaccordprojectXisdaXirsXSimpleInterestRateSwap.check(pcontext);
}
/* Generated using ergo version 0.21.9 */
'use strict';
/*eslint-disable no-unused-vars*/
...
/*eslint-disable no-var*/
const inheritance=[ {
    "sub": ("org.accordproject.isda.irs.InterestRateSwapContract"), 
    "sup": ("org.accordproject.contract.Contract")
  }, {
    "sub": ("org.accordproject.isda.irs.InterestRateSwapContract"), 
    "sup": ("concerto.Asset")
  }, {
    "sub": ("org.accordproject.isda.irs.Result"), 
    "sup": ("org.accordproject.runtime.Response")
  }, {
    "sub": ("org.accordproject.isda.irs.Result"), 
    "sup": ("concerto.Transaction")
  }, {
    "sub": ("org.accordproject.isda.irs.RateObservation"), 
    "sup": ("org.accordproject.runtime.Request")
  }, {
    "sub": ("org.accordproject.isda.irs.RateObservation"), 
    "sup": ("concerto.Transaction")
  }, {
    "sub": ("org.accordproject.organization.Organization"), 
    "sup": ("concerto.Participant")
  }, {
    "sub": ("org.accordproject.geo.CountryCodeISOAlpha2"), 
    "sup": ("concerto.Enum")
  }, {
...
class orgXaccordprojectXisdaXirsXSimpleInterestRateSwap{
                  ...
                  __this = recDot(constants0, "__contract");;
                  {
                    let $match0;
                    {
                      ...
                      $match0 = recDot(constants0, "request");;
                      {
                        ...
                        {
                          ;
                          if (either(cast(array("org.accordproject.isda.irs.RateObservation"), $match0))) {
                            {
                              let $case0 = toLeft(cast(array("org.accordproject.isda.irs.RateObservation"), $match0));
                              stratify0 = {
                                  "$left": ({
                                    "$$main": ($case0)
                                  })
                            ...
                            {
                              let $case1 = toRight(cast(array("org.accordproject.isda.irs.RateObservation"), $match0));
                              stratify0 = {
                                  "$right": (null)
                                };
                            }
                                                            ...
                                                            let __lemit$0;
                                                            {
                                                              ...
                                                              __lemit$0 = recDot(constants0, "__emit");;
                                                              {
                                                                let __this$0;
                                                                {
                                                                  ...
                                                                  if ((!(recDot(unbrand(recDot(constants0, "__contract")), "fixedRate") >= 0.0))) {
                                                                    {
                                                                      let stratify0$0;
                                                                      {
                                                                        ;
                                                                        {
                                                                          ...
                                                                          {
                                                                            ;
                                                                            x = "Fixed rate cannot be negative";;
                                                                            stratify0$0 = brand(array("org.accordproject.ergo.stdlib.Error"), {
                                                                                  "message": (x)
                                                                                });
                                                                          }
                                                                        };
                                                                    ...
                                                                    if ((!(recDot(unbrand(recDot(unbrand(recDot(constants0, "__contract")), "notionalAmount")), "doubleValue") >= 0.0))) {
                                                                      {
                                                                        let stratify0$0;
                                                                        {
                                                                          ;
                                                                          {
                                                                            ...
                                                                            {
                                                                              ;
                                                                              x = "Notional amount cannot be negative";;
                                                                              stratify0$0 = brand(array("org.accordproject.ergo.stdlib.Error"), {
                                                                                    "message": (x)
                                                                                  });
                                                                            }
                                                                      ...
                                                                      ret0 = {
                                                                          "$left": (recConcat(recConcat({
                                                                                "__response": (brand(array("org.accordproject.isda.irs.Result"), {
                      ...
                      let stratify0;
                      {
                        ;
                        {
                          let x;
                          {
                            ;
                            x = "Fixed rate cannot be negative";;
                            stratify0 = brand(array("org.accordproject.ergo.stdlib.Error"), {
                                  "message": (x)
                                });
                          }
                        };
...
function orgXaccordprojectXisdaXirsXcompoundInterestMultiple(constants0) {
  {
    let ret0;
    ret0 = Math["pow"]((1.0 + recDot(constants0, "annualInterest")), (recDot(constants0, "numberOfDays") / 365.0));;
    return ret0;
  }
}
...
function __dispatch(context) {
  let pcontext = Object.assign(context, { 'request' : context.request });
  return orgXaccordprojectXisdaXirsXSimpleInterestRateSwap.main(pcontext);
}
function __init(context) {
  let pcontext = Object.assign(context, { 'state': { '$class': 'org.accordproject.runtime.ContractState' } });
  return new orgXaccordprojectXisdaXirsXSimpleInterestRateSwap().init(pcontext);
}
/*eslint-enable no-unused-vars*/
/*eslint-enable no-undef*/
/*
