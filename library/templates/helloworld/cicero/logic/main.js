 ...
 * @param {org.accordproject.helloworldstate.HelloWorldState} context.state - the state
 */

function orgXaccordprojectXhelloworldstateXHelloWorldState_helloworldstate(context) {
  let pcontext = Object.assign(context, { 'request' : context.request });
  return orgXaccordprojectXhelloworldstateXHelloWorldState.helloworldstate(pcontext);
}
/* Generated using ergo version 0.21.9 */
'use strict';
/*eslint-disable no-unused-vars*/
...
/*eslint-disable no-var*/
const inheritance=[ {
    "sub": ("org.accordproject.helloworldstate.HelloWorldClause"), 
    "sup": ("org.accordproject.contract.Clause")
  }, {
    "sub": ("org.accordproject.helloworldstate.HelloWorldClause"), 
    "sup": ("concerto.Asset")
  }, {
    "sub": ("org.accordproject.helloworldstate.HelloWorldState"), 
    "sup": ("org.accordproject.runtime.State")
  }, {
    "sub": ("org.accordproject.helloworldstate.HelloWorldState"), 
    "sup": ("concerto.Asset")
  }, {
    "sub": ("org.accordproject.helloworldstate.MyResponse"), 
    "sup": ("org.accordproject.runtime.Response")
  }, {
    "sub": ("org.accordproject.helloworldstate.MyResponse"), 
    "sup": ("concerto.Transaction")
  }, {
    "sub": ("org.accordproject.helloworldstate.MyRequest"), 
...
class orgXaccordprojectXhelloworldstateXHelloWorldState{
                  ...
                  __this = recDot(constants0, "__contract");;
                  {
                    let $match0;
                    {
                      ...
                      $match0 = recDot(constants0, "request");;
                      {
                        ...
                        {
                          ;
                          if (either(cast(array("org.accordproject.helloworldstate.MyRequest"), $match0))) {
                            {
                              let $case0 = toLeft(cast(array("org.accordproject.helloworldstate.MyRequest"), $match0));
                              stratify0 = {
                                  "$left": ({
                                    "$$main": ($case0)
                                  })
                            ...
                            {
                              let $case1 = toRight(cast(array("org.accordproject.helloworldstate.MyRequest"), $match0));
                              stratify0 = {
                                  "$right": (null)
                                };
                            }
                                                  ...
                                                  __emit = __lemit;;
                                                  {
                                                    let request;
                                                    {
                                                      ...
                                                      request = $main;;
                                                      {
                                                        ...
                                                        {
                                                          ;
                                                          __lstate$1 = recDot(constants0, "__state");;
                                                          {
                                                            let __lemit$0;
                                                            {
                                                              ;
                                                              __lemit$0 = recDot(constants0, "__emit");;
                                                              {
                                                                let __this$0;
                                                                {
                                                                  ...
                                                                  __this$0 = recDot(constants0, "__contract");;
                                                                  {
                                                                    ...
                                                                    {
                                                                      ;
                                                                      newCounter = (recDot(unbrand(__lstate$1), "counter") + 1.0);;
                                                                      {
                                                                        let __lstate$0;
                                                                        {
                                                                          ;
                                                                          __lstate$0 = brand(array("org.accordproject.helloworldstate.HelloWorldState"), {
                                                                                "counter": (newCounter)
                                                                              });;
                                                                          {
                                                                            let stratify0$0;
                                                                            {
                                                                              ;
                                                                              {
                                                                                ...
                                                                                {
                                                                                  ;
                                                                                  p0 = recDot(unbrand(__lstate$0), "counter");;
                                                                                  stratify0$0 = toString(p0);
                                                                                }
                                                                              };
                                                                              ret0 = {
                                                                                  "$left": (recConcat(recConcat({
                                                                                        "__response": (brand(array("org.accordproject.helloworldstate.MyResponse"), {
                                                                                            "output": ((((((("Hello " + recDot(unbrand(recDot(constants0, "__contract")), "name")) + " ") + recDot(unbrand(recDot(constants0, "request")), "input")) + "(") + stratify0$0) + ")"))
                                                                                          }))
                                                                                      }, {
                                                                                        "__state": (__lstate$0)
                                                                                      }), {
  ...
  static helloworldstate(constants0) {
    {
      let ret0;
      {
        let __lstate;
              ...
              __lemit = recDot(constants0, "__emit");;
              {
                let __this;
                {
                  ...
                  __this = recDot(constants0, "__contract");;
                  {
                    ...
                    {
                      ;
                      newCounter = (recDot(unbrand(__lstate), "counter") + 1.0);;
                      {
                        let __lstate$0;
                        {
                          ;
                            ...
                            let stratify0;
                            {
                              ;
                              {
                                let p0;
                                {
                                  ;
                                  p0 = recDot(unbrand(__lstate$0), "counter");;
                                  stratify0 = toString(p0);
                                }
                              };
                              ret0 = {
                                  "$left": (recConcat(recConcat({
                                        "__response": (brand(array("org.accordproject.helloworldstate.MyResponse"), {
                                            "output": ((((((("Hello " + recDot(unbrand(recDot(constants0, "__contract")), "name")) + " ") + recDot(unbrand(recDot(constants0, "request")), "input")) + "(") + stratify0) + ")"))
                                          }))
                                      }, {
                                        "__state": (__lstate$0)
                                      }), {
                ...
                let __this;
                {
                  ...
                  __this = recDot(constants0, "__contract");;
                  {
                    let __lstate$0;
                    {
                      ...
                      ret0 = {
                          "$left": (recConcat(recConcat({
                                "__response": (brand(array("org.accordproject.runtime.Response"), {
                                  }))
                              }, {
                                "__state": (__lstate$0)
                              }), {
...
function __dispatch(context) {
  let pcontext = Object.assign(context, { 'request' : context.request });
  return orgXaccordprojectXhelloworldstateXHelloWorldState.main(pcontext);
}
function __init(context) {
  let pcontext = Object.assign(context, { 'state': { '$class': 'org.accordproject.runtime.ContractState' } });
  return new orgXaccordprojectXhelloworldstateXHelloWorldState().init(pcontext);
}
/*eslint-enable no-unused-vars*/
/*eslint-enable no-undef*/
/*
